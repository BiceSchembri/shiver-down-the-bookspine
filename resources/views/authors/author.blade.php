...
<div>
    ...
    <p><a href="/books/detail/{{$book->slug}}">{{$book->title}}</a></p>
@endforeach

</div>

{{-- EDIT AND DELETE WILL ONLY BE VISIBLE TO ADMIN --}}
<a href="/authors/edit/{{$author->slug}}" class="bg-blue-400 text-white rounded mt-2 p-1 hover:bg-blue-500">Edit Author</a>
