...
<div class="bg-gray-900 text-white">
    <div class="container mx-auto mt-10">
        <h1 class="text-3xl font-bold mb-5 p-2">Books</h1>
            ...
            <table class="table-auto border-collapse border border-gray-700 w-full">
                <thead>
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left uppercase">Language</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border border-gray-700 px-4 py-2 text-left text-purple-200">{{$book->language->name}}</td>
